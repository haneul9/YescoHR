sap.ui.define(
  ...
  (
    ...
    /**
    <OverflowToolbar visible="{= !!${/ReWriteBtn} || ${ZappStatAl} !== '30' &amp;&amp; ${ZappStatAl} !== '40' &amp;&amp; ${ZappStatAl} !== '60' &amp;&amp; ${ZappStatAl} !== 'XX' }">
     ...
     */
    return OverflowToolbar.extend('sap.ui.yesco.control.ApprovalRequestDetailFooterToolbar', {
      metadata: {
        properties: {
