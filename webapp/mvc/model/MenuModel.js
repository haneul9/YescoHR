    ...
    return UIComponentBaseModel.extend('sap.ui.yesco.mvc.model.MenuModel', {
      ...
      curryData({ GetMenuLv1Nav = {}, GetMenuLv2Nav = {}, GetMenuLv3Nav = {}, GetMenuLv4Nav = {} }) {
        ...
        aLevel3.map((m) => {
          ...
          if (m.Favor === 'X') {
            mFavoriteMenus[m.Menid] = mMenuProperties;
          }
        ...
        return {
          ...
          favoriteMenuMap: mFavoriteMenus,
          current: {},
          breadcrumbs: {},
        };
      },
      ...
      addFavoriteMenus(sMenid) {
        ...
        this.setProperty(`/favoriteMenuMap/${sMenid}`, this.getProperties(sMenid));
      },
