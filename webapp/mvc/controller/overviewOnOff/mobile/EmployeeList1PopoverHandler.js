sap.ui.define(
  ...
  (
    ...
    return MobileEmployeeListPopoverHandler.extend('sap.ui.yesco.mvc.controller.overviewOnOff.mobile.EmployeeList1PopoverHandler', {
      getPopoverFragmentName() {
        return 'sap.ui.yesco.mvc.view.overviewOnOff.mobile.EmployeeList1Popover';
      },
