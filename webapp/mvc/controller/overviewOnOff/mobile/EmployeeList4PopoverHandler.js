sap.ui.define(
  ...
  (
    ...
    return MobileEmployeeListPopoverHandler.extend('sap.ui.yesco.mvc.controller.overviewOnOff.mobile.EmployeeList4PopoverHandler', {
      getPopoverFragmentName() {
        return 'sap.ui.yesco.mvc.view.overviewOnOff.mobile.EmployeeList4Popover';
      },
      ...
      async onBeforeOpen() {
        ...
        this.setEmployeeList(
          aEmployees.map(({ Photo, Ename, Pernr, Zzjikgbtx, Zzjikchtx, Orgtx, Ageyy, Svryy }) => ({
