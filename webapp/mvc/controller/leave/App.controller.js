sap.ui.define(
  ...
  (
    ...
    return BaseController.extend('sap.ui.yesco.mvc.controller.leave.App', {
      ...
      CHARTS: {
        ACC: { color: '#dc3545', label: 'LABEL_16018', prop: 'Cumuse', propPert: 'Cumrte' },
        CUR: { color: '#2972c8', label: 'LABEL_16020', prop: 'Monuse', propPert: 'Monrte' },
      },
          ...
          oViewModel.setProperty('/summary/dataset', [
            {
              ...
              data: _.chain(mGroupByOyymm)
                .map((v) => ({ value: _.get(v, [0, this.CHARTS.ACC.propPert]) }))
                .forEach((v, i, o) => {
            ...
            },
            {
              ...
              data: _.map(mGroupByOyymm, (v) => ({ value: _.get(v, [0, this.CHARTS.CUR.propPert], 0) })),
            },
          ]);
