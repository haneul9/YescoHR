  ...
  (
    ...
    return AbstractPortletHandler.extend('sap.ui.yesco.mvc.controller.home.portlets.P07PortletHandler', {
      ...
      transformContentData(aPortletContentData = []) {
        // TEST
        aPortletContentData.push({ Seqnr: '1', Menid: '21100', Mennm: '근태신청' });
        aPortletContentData.push({ Seqnr: '2', Menid: '21400', Mennm: '통합굴착야간근무변경신청' });
        aPortletContentData.push({ Seqnr: '3', Menid: '21300', Mennm: '당직변경신청' });
        // TEST-end
