sap.ui.define(
  [
    ...
    'sap/ui/yesco/mvc/controller/home/portlets/M23PortletHandlerDialogHandler',
  ...
  (
    ...
    M23PortletHandlerDialogHandler,
    ...
    return AbstractPortletHandler.extend('sap.ui.yesco.mvc.controller.home.portlets.M23PortletHandler', {
      ...
      async addPortlet() {
        ...
        this.oEmployeeListPopupHandler = this.oEmployeeListPopupHandler || (this.bMobile ? new EmployeeList3PopoverHandler(oController) : new M23PortletHandlerDialogHandler(oController));
      },
