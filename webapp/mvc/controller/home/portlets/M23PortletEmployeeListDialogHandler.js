sap.ui.define(
  ...
  (
    ...
    return Debuggable.extend('sap.ui.yesco.mvc.controller.home.portlets.M23PortletEmployeeListDialogHandler', {
      ...
      async openDialog(mPayload) {
        try {
          ...
          this.debug('M23PortletEmployeeListDialogHandler > openDialog Error', oError);
